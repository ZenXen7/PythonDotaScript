    ...
    try:
        ...
        while not button_found:
            for image_path in image_paths:
                accept_button_location = pyautogui.locateOnScreen(image_path, minSearchTime=100000, confidence=0.7)
...
def find_hero():
    global button_found  # Declare as global inside this function
    global hero_found
    hero_found = False       
    try:
...
def pick_hero():
    global hero_found  # Declare as global inside this function
    try:
